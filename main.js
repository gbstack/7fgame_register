...
lastNameList = lastNameList.split("\n");
lastNameList.map(function(d) {
    lastNames = lastNames.concat(d.split(" "));
});
...
function getRandomLastName(){
    return lastNames[parseInt(Math.random()*lastNames.length)-1];
}

function generateUsername(){
    var name = '';
    var nameLength = parseInt(Math.random()*2)+2;
...
qifanRegister.password = '233g8gg';
qifanRegister.realName = '屠晨程';
qifanRegister.idNo = '450302197510036770';
function byId(id){
    return document.getElementById(id);
};
(function(){
    byId('txt_userName').focus();
    byId('txt_userName').value = generateUsername();
    byId('txt_uReg_Pwd').value=qifanRegister.password;
    byId('txt_uReg_ConfirmPwd').value=qifanRegister.password;
    byId('txt_uReg_RealName').value=qifanRegister.realName;
    byId('txt_uReg_idCard').value=qifanRegister.idNo;
    byId('txt_uReg_ValidCode').focus();
...
function checkUserExisted(){
    ...
    xhr.open('POST', 'http://uc.7fgame.com/Register/IsExsitsUser');
    xhr.send();
}